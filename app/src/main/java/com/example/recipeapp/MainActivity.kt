...
class MainActivity : AppCompatActivity(),RecipeAdapter.Listener{
    ...
    private val favrecipeViewModel: FavViewModel by viewModels { RecipeViewModelFactory(favRecipeRespository) }
            ...
            when (recipe) {
                ...
                is ResultRes.Success -> {
                    ...
                    favrecipeViewModel.favoriteRecipeIds.observe(this){
                        binding.recipeRecycler.adapter=RecipeAdapter(recipe.data,this@MainActivity,it)
